# 公网连接Redis实例<a name="dcs-zh-ug-180316001"></a>
...
4.  <a name="li11161015556"></a>配置Stunnel客户端。在任务栏单击图标![](figures/icon-editconfig.png)右键，选择“Edit Configration”，新增如下配置内容，然后保存退出。
