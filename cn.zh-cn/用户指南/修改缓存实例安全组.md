# 修改缓存实例安全组<a name="ZH-CN_TOPIC_0088504580"></a>
...
4.  单击左侧菜单栏的“缓存管理”。
5.  单击需要修改的DCS缓存实例名称。
6.  在打开的DCS缓存实例基本信息页面，单击“安全组”后的![](figures/zh-cn_image_0088504583.jpg)。
7.  下拉选择新的安全组。单击![](figures/zh-cn_image_0088504586.jpg)保存修改，单击![](figures/zh-cn_image_0088504593.jpg)取消修改。
