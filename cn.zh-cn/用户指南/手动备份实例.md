# 手动备份实例<a name="zh-cn_topic_0057919778"></a>
...
## 实例维护操作视频<a name="section8989142218335"></a>

如果需要详细了解维护实例的操作，请单击以下链接观看视频。

[缓存实例日常维护](https://support.huaweicloud.com/dcs_video/index.html)

## 使用API方式备份指定实例<a name="section1983962016368"></a>

您还可以使用API的方式备份指定实例，具体操作请查看以下链接。

[备份指定实例](https://support.huaweicloud.com/api-dcs/dcs-zh-api-180423033.html)
