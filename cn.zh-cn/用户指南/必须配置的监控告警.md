...
<td class="cellrowborder" valign="top" width="43.37%" headers="mcps1.2.6.1.5 "><p id="p392219126402"><a name="p392219126402"></a><a name="p392219126402"></a>结合业务分析是否由于业务上涨导致的。</p>
...
<p id="p1490915434182"><a name="p1490915434182"></a><a name="p1490915434182"></a>告警级别：重要</p>
</td>
...
<p id="p47971146055"><a name="p47971146055"></a><a name="p47971146055"></a>仅单机和集群实例配置该指标，如果是集群实例，在数据节点和Proxy节点配置即可。</p>
<p id="p162827279617"><a name="p162827279617"></a><a name="p162827279617"></a>单机和集群实例，最大连接数限制为10000（64G规格为12000），可以根据业务情况对阈值进行调整。</p>
</td>
</tr>
...
<p id="p81251632977"><a name="p81251632977"></a><a name="p81251632977"></a>仅单机和集群实例配置该指标，如果是集群实例，在数据节点和Proxy节点配置即可。</p>
</td>
</tr>
...
<p id="p1216916461612"><a name="p1216916461612"></a><a name="p1216916461612"></a>不同规格的带宽限制，请查看<a href="https://support.huaweicloud.com/productdesc-dcs/zh-cn_topic_0033568446.html" target="_blank" rel="noopener noreferrer">实例规格</a>页面。</p>
...
<p id="p11533201717185"><a name="p11533201717185"></a><a name="p11533201717185"></a>不同规格的带宽限制，请查看<a href="https://support.huaweicloud.com/productdesc-dcs/zh-cn_topic_0033568446.html" target="_blank" rel="noopener noreferrer">实例规格</a>页面。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40.839999999999996%" headers="mcps1.2.6.1.5 "><p id="p15142141719409"><a name="p15142141719409"></a><a name="p15142141719409"></a>通过慢日志查询功能分析具体的慢日志命令。</p>
</td>
</tr>
...
<p id="p139912685317"><a name="p139912685317"></a><a name="p139912685317"></a>其中，带宽使用率超过100%，不一致导致限流，有没有被流控需要看流控次数指标。</p>
