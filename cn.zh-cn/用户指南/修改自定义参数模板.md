# 修改自定义参数模板<a name="ZH-CN_TOPIC_0000001123120752"></a>
...
5.  可以通过两种方式修改自定义参数模板。
    ...
    **表 1**  Redis缓存实例参数说明
    ...
    <table><thead align="left"><tr id="row161951132613"><th class="cellrowborder" valign="top" width="24.97%" id="mcps1.2.5.1.1"><p id="p3392940668"><a name="p3392940668"></a><a name="p3392940668"></a>参数名</p>
    </th>
    <th class="cellrowborder" valign="top" width="25.03%" id="mcps1.2.5.1.2"><p id="p63924401620"><a name="p63924401620"></a><a name="p63924401620"></a>参数解释</p>
    </th>
    ...
    <tbody><tr id="row111956316617"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p19802145512615"><a name="p19802145512615"></a><a name="p19802145512615"></a>timeout</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p78026551060"><a name="p78026551060"></a><a name="p78026551060"></a>客户端与服务端连接空闲超时断开时间，参数设为0表示连接永不断开。</p>
    </td>
    ...
    <tr id="row10195331561"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p12802165518616"><a name="p12802165518616"></a><a name="p12802165518616"></a>appendfsync</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p148023551618"><a name="p148023551618"></a><a name="p148023551618"></a>操作系统的fsync函数刷新缓冲区数据到磁盘，有些操作系统会真正刷新磁盘上的数据，其他一些操作系统只会尝试尽快完成。</p>
    ...
    <tr id="row6195136612"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p1993317296716"><a name="p1993317296716"></a><a name="p1993317296716"></a>appendonly</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p179331429776"><a name="p179331429776"></a><a name="p179331429776"></a>指定是否在每次更新操作后进行日志记录，Redis在默认情况下是异步的把数据写入磁盘，如果不开启，可能会在断电时导致一段时间内的数据丢失。有2个取值供选择：</p>
    ...
    <tr id="row20195231369"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p1193312291670"><a name="p1193312291670"></a><a name="p1193312291670"></a>client-output-buffer-limit-slave-soft-seconds</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p1933029076"><a name="p1933029076"></a><a name="p1933029076"></a>主从同步缓冲区大小软限制持续秒数。</p>
    </td>
    ...
    <tr id="row81961315612"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p1193312913712"><a name="p1193312913712"></a><a name="p1193312913712"></a>maxmemory-policy</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p1093314291277"><a name="p1093314291277"></a><a name="p1093314291277"></a>内存使用达到上限时，对缓存数据的逐出策略。</p>
    ...
    <tr id="row2196173964"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p20934929879"><a name="p20934929879"></a><a name="p20934929879"></a>lua-time-limit</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p8934152919716"><a name="p8934152919716"></a><a name="p8934152919716"></a>Lua脚本的最长执行时间，单位为毫秒。</p>
    </td>
    ...
    <tr id="row191976316616"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p1593412911715"><a name="p1593412911715"></a><a name="p1593412911715"></a>master-read-only</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p1793410295714"><a name="p1793410295714"></a><a name="p1793410295714"></a>设置实例为只读状态。设置只读后，所有写入命令将返回失败。</p>
    </td>
    ...
    <tr id="row171986317610"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p10935629876"><a name="p10935629876"></a><a name="p10935629876"></a>proto-max-bulk-len</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p3935132911720"><a name="p3935132911720"></a><a name="p3935132911720"></a>Redis协议中的最大的请求大小，单位为字节。</p>
    </td>
    ...
    <tr id="row51981531862"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p1293518299717"><a name="p1293518299717"></a><a name="p1293518299717"></a>repl-backlog-size</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p189359291711"><a name="p189359291711"></a><a name="p189359291711"></a>用于增量同步的复制积压缓冲区大小（单位为字节）。这是一个用来在从节点断开连接时，存放从节点数据的缓冲区，当从节点重新连接时，如果丢失的数据少于缓冲区的大小，可以用缓冲区中的数据开始增量同步。</p>
    </td>
    ...
    <tr id="row191984311617"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p119355296711"><a name="p119355296711"></a><a name="p119355296711"></a>repl-backlog-ttl</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p8935629471"><a name="p8935629471"></a><a name="p8935629471"></a>从节点断开后，主节点释放复制积压缓冲区内存的秒数。值为0时表示永不释放复制积压缓冲区内存。</p>
    </td>
    ...
    <tr id="row2199836616"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p1293519291576"><a name="p1293519291576"></a><a name="p1293519291576"></a>repl-timeout</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p119351629371"><a name="p119351629371"></a><a name="p119351629371"></a>主从同步超时时间，单位为秒。</p>
    </td>
    ...
    <tr id="row171992311614"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p3936729973"><a name="p3936729973"></a><a name="p3936729973"></a>hash-max-ziplist-entries</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p12936172914716"><a name="p12936172914716"></a><a name="p12936172914716"></a>当hash表中记录数少于参数值，使用ziplist编码格式，节约内存。</p>
    </td>
    ...
    <tr id="row419912314613"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p1393614294715"><a name="p1393614294715"></a><a name="p1393614294715"></a>hash-max-ziplist-value</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p1793602913713"><a name="p1793602913713"></a><a name="p1793602913713"></a>当hash表中各字段长度的最大值小于参数值时，使用ziplist编码格式，节约内存。</p>
    </td>
    ...
    <tr id="row181991536612"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p16936329474"><a name="p16936329474"></a><a name="p16936329474"></a>set-max-intset-entries</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p159361529675"><a name="p159361529675"></a><a name="p159361529675"></a>当一个集合仅包含字符串且整形元素数量少于参数值时，使用intset编码格式，节约内存。</p>
    </td>
    ...
    <tr id="row101991431069"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p693612295719"><a name="p693612295719"></a><a name="p693612295719"></a>zset-max-ziplist-entries</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p18936029872"><a name="p18936029872"></a><a name="p18936029872"></a>当有序集合中记录数少于参数值，使用ziplist编码格式，节约内存。</p>
    </td>
    ...
    <tr id="row192001036613"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p1893611294718"><a name="p1893611294718"></a><a name="p1893611294718"></a>zset-max-ziplist-value</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p1793611291374"><a name="p1793611291374"></a><a name="p1793611291374"></a>当有序集合中各字段长度的最大值小于参数值时，使用ziplist编码格式，节约内存。</p>
    </td>
    ...
    <tr id="row15200163869"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p89368296711"><a name="p89368296711"></a><a name="p89368296711"></a>latency-monitor-threshold</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p9937142920717"><a name="p9937142920717"></a><a name="p9937142920717"></a>延时监控的采样时间阈值（最小值）。</p>
    ...
    <tr id="row3200531166"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p10937229371"><a name="p10937229371"></a><a name="p10937229371"></a>notify-keyspace-events</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p20937102912717"><a name="p20937102912717"></a><a name="p20937102912717"></a>键空间通知，配置该参数后客户端可以通过Redis的订阅与发布功能，来接收那些以某种方式改动了Redis数据集的事件。</p>
    </td>
    ...
    <tr id="row12200831617"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p1493713291719"><a name="p1493713291719"></a><a name="p1493713291719"></a>slowlog-log-slower-than</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p693718296718"><a name="p693718296718"></a><a name="p693718296718"></a>Reids慢查询会记录超过指定执行时间的命令。slowlog-log-slower-than用于配置记录到慢查询的命令执行时间阈值，其以微秒为单位。</p>
    </td>
    ...
    <tr id="row17200834613"><td class="cellrowborder" valign="top" width="24.97%" headers="mcps1.2.5.1.1 "><p id="p119384298710"><a name="p119384298710"></a><a name="p119384298710"></a>slowlog-max-len</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.03%" headers="mcps1.2.5.1.2 "><p id="p393814291371"><a name="p393814291371"></a><a name="p393814291371"></a>慢查询记录的条数。注意慢查询记录会消耗额外的内存。可以通过执行SLOWLOG RESET命令清除慢查询记录。</p>
    </td>
