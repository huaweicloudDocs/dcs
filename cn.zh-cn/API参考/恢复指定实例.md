# 恢复指定实例<a name="RestoreInstance"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=DCS&api=RestoreInstance)中调试该接口，并获取该接口关联的CLI示例：  [hcloud DCS RestoreInstance](https://apiexplorer.developer.huaweicloud.com/apiexplorer/cli?product=DCS&api=RestoreInstance)。

## URI

POST /v2/\{project\_id\}/instances/\{instance\_id\}/restores
...
<a name="request_RestoreInstanceBody"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.2"><p>是否必选</p>
</th>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>恢复缓存实例的备注信息。</p>
</td>
</tr>
</tbody>
</table>
...
<a name="response_RestoreInstanceResp"></a>
...
<tbody><tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p>restore_id</p>
</td>
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>恢复指定实成功。</p>
</td>
</tr>
