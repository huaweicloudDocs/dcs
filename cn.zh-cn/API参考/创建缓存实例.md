...
## 功能描述<a name="section682614592540"></a>

创建缓存实例，该接口创建的缓存实例支持按需计费和包周期两种方式。

在进行接口调用之前，请先完成以下工作：

1.  使用Token认证和AK/SK认证方式，请先仔细阅读[Token认证](Token认证.md)和[AK/SK认证](AK-SK认证.md)中的接口调用示例，了解接口调用流程和操作。
2.  缓存实例运行于虚拟私有云（VPC）中，创建前，当前租户需要先创建VPC、安全组和子网，并获取对应的VPC ID、安全组ID和子网ID。
    ...
    -   获取子网ID（即subnet\_id参数）
        ...
        在创建缓存实例时，需要用到的是VPC子网的网络ID，而不是下图中显示子网ID。
...
3.  参考本手册的[查询可用区信息](查询可用区信息.md)章节，提前获取租户创建的缓存实例的可用区ID，确认可用区是否有资源。
...
## 请求参数<a name="section4413221154412"></a>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.2.5.1.4 "><p id="p1367712201792"><a name="p1367712201792"></a><a name="p1367712201792"></a>缓存引擎：Redis、IMDG和Memcached。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="10.89%" headers="mcps1.2.5.1.3 "><p id="p4173155412212"><a name="p4173155412212"></a><a name="p4173155412212"></a></p>
<p id="p76771201693"><a name="p76771201693"></a><a name="p76771201693"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.2.5.1.4 "><p id="p1677120998"><a name="p1677120998"></a><a name="p1677120998"></a>缓存版本，当缓存引擎为Redis时，取值为3.0.7、4.0.11或5.0.2。</p>
</td>
</tr>
...
<p id="p1700124711119"><a name="p1700124711119"></a><a name="p1700124711119"></a></p>
<a name="ul2084493514411"></a><a name="ul2084493514411"></a><ul id="ul2084493514411"><li>Redis引擎：单机和主备类型实例取值：2、4、8、16、32、64。集群实例规格支持64G、128G、256G、512G和1024G。</li><li>Memcached引擎：单机和主备类型实例取值：2、4、8、16、32、64。</li><li>IMDG引擎：单机类型实例取值：2、4、8，集群类型实例取值：16。</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="10.89%" headers="mcps1.2.5.1.3 "><p id="p16515175245516"><a name="p16515175245516"></a><a name="p16515175245516"></a>否</p>
</td>
...
<div class="note" id="note6531125245510"><a name="note6531125245510"></a><a name="note6531125245510"></a><span class="notetitle"> 说明： </span><div class="notebody"><a name="ul1853315235516"></a><a name="ul1853315235516"></a><ul id="ul1853315235516"><li>当缓存引擎为“Redis”和“Memcached”时该参数支持配置为“true”或者“false”。</li><li>当缓存引擎为“IMDG”时该参数只能配置为“false”或者空，即对于IMDG引擎的缓存实例必须要通过密码认证才能访问。</li></ul>
</div></div>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="10.89%" headers="mcps1.2.5.1.3 "><p id="p41909571216"><a name="p41909571216"></a><a name="p41909571216"></a></p>
<p id="p467710201891"><a name="p467710201891"></a><a name="p467710201891"></a>否</p>
</td>
...
<div class="note" id="note1070516012285"><a name="note1070516012285"></a><a name="note1070516012285"></a><span class="notetitle"> 说明： </span><div class="notebody"><a name="ul1078991122814"></a><a name="ul1078991122814"></a><ul id="ul1078991122814"><li>当缓存引擎为IMDG时，该参数为必填项。</li><li>当缓存引擎为Memcached时，该参数为可选项。</li><li>当缓存引擎为Redis时，该参数不需要设置。</li></ul>
</div></div>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.2.5.1.4 "><p id="p16517143816118"><a name="p16517143816118"></a><a name="p16517143816118"></a>租户VPC ID。</p>
<p id="p145558581473"><a name="p145558581473"></a><a name="p145558581473"></a>获取方法请参考<a href="#section682614592540">功能描述</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.2.5.1.4 "><p id="p1012535151112"><a name="p1012535151112"></a><a name="p1012535151112"></a>租户安全组ID。</p>
<p id="p683515420568"><a name="p683515420568"></a><a name="p683515420568"></a>获取方法请参考<a href="#section682614592540">功能描述</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.2.5.1.4 "><p id="p6957182201210"><a name="p6957182201210"></a><a name="p6957182201210"></a>子网ID。</p>
<p id="p394819577568"><a name="p394819577568"></a><a name="p394819577568"></a>获取方法请参考<a href="#section682614592540">功能描述</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="10.89%" headers="mcps1.2.5.1.3 "><p id="p567815201913"><a name="p567815201913"></a><a name="p567815201913"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.2.5.1.4 "><p id="p12678420696"><a name="p12678420696"></a><a name="p12678420696"></a>创建缓存节点到指定且有资源的可用区ID。具体查询方法，请参考<a href="查询可用区信息.md">查询可用区信息</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.2.5.1.4 "><p id="p178019382126"><a name="p178019382126"></a><a name="p178019382126"></a>备份策略，实例类型为主备和集群时支持。具体备份参数，请参考<a href="#table12803218151513">表3</a>和<a href="#table187492037201518">表4</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.2.5.1.4 "><p id="p170500927"><a name="p170500927"></a><a name="p170500927"></a>表示包周期计费模式的相关参数。如果为空，则默认计费模式为按需计费；如果是包周期方式，请参考<a href="#table0424534930">表5</a>设置。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="55.00000000000001%" headers="mcps1.2.5.1.4 "><p id="p7804101841518"><a name="p7804101841518"></a><a name="p7804101841518"></a>备份计划，具体请参考<a href="#table187492037201518">表4</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="10%" headers="mcps1.2.5.1.3 "><p id="p1612913542306"><a name="p1612913542306"></a><a name="p1612913542306"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="55.00000000000001%" headers="mcps1.2.5.1.4 "><p id="p131291554143018"><a name="p131291554143018"></a><a name="p131291554143018"></a>备份的时区。取值为-1200 ~+1200之间的时区。若为空则默认使用DCS-Server节点的当前时区。</p>
</td>
</tr>
</tbody>
</table>
...
<table><thead align="left"><tr id="row174367341131"><th class="cellrowborder" valign="top" width="18.87%" id="mcps1.2.5.1.1"><p id="p184371534335"><a name="p184371534335"></a><a name="p184371534335"></a>参数</p>
</th>
<th class="cellrowborder" valign="top" width="13.170000000000002%" id="mcps1.2.5.1.2"><p id="p0439193410319"><a name="p0439193410319"></a><a name="p0439193410319"></a>类型</p>
</th>
<th class="cellrowborder" valign="top" width="7.8100000000000005%" id="mcps1.2.5.1.3"><p id="p1444210341733"><a name="p1444210341733"></a><a name="p1444210341733"></a>必选</p>
</th>
<th class="cellrowborder" valign="top" width="60.150000000000006%" id="mcps1.2.5.1.4"><p id="p7445834732"><a name="p7445834732"></a><a name="p7445834732"></a>说明</p>
</th>
</tr>
</thead>
<tbody><tr id="row344712344311"><td class="cellrowborder" valign="top" width="18.87%" headers="mcps1.2.5.1.1 "><p id="p1913410231413"><a name="p1913410231413"></a><a name="p1913410231413"></a>charging_mode</p>
</td>
<td class="cellrowborder" valign="top" width="13.170000000000002%" headers="mcps1.2.5.1.2 "><p id="p313417236416"><a name="p313417236416"></a><a name="p313417236416"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="7.8100000000000005%" headers="mcps1.2.5.1.3 "><p id="p17134423046"><a name="p17134423046"></a><a name="p17134423046"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="60.150000000000006%" headers="mcps1.2.5.1.4 "><p id="p7134623843"><a name="p7134623843"></a><a name="p7134623843"></a>功能说明：付费方式（预付费、按需付费；预付费，即包周期付费）</p>
...
<tr id="row154585341639"><td class="cellrowborder" valign="top" width="18.87%" headers="mcps1.2.5.1.1 "><p id="p128324330419"><a name="p128324330419"></a><a name="p128324330419"></a>is_auto_pay</p>
</td>
<td class="cellrowborder" valign="top" width="13.170000000000002%" headers="mcps1.2.5.1.2 "><p id="p28321336411"><a name="p28321336411"></a><a name="p28321336411"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="7.8100000000000005%" headers="mcps1.2.5.1.3 "><p id="p78327331411"><a name="p78327331411"></a><a name="p78327331411"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="60.150000000000006%" headers="mcps1.2.5.1.4 "><p id="p168321331940"><a name="p168321331940"></a><a name="p168321331940"></a>功能说明：下单订购后，是否自动从客户的账户中支付；默认是“不自动支付”</p>
...
<tr id="row208504421937"><td class="cellrowborder" valign="top" width="18.87%" headers="mcps1.2.5.1.1 "><p id="p19974445442"><a name="p19974445442"></a><a name="p19974445442"></a>period_type</p>
</td>
<td class="cellrowborder" valign="top" width="13.170000000000002%" headers="mcps1.2.5.1.2 "><p id="p7974144518414"><a name="p7974144518414"></a><a name="p7974144518414"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="7.8100000000000005%" headers="mcps1.2.5.1.3 "><p id="p597417451047"><a name="p597417451047"></a><a name="p597417451047"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="60.150000000000006%" headers="mcps1.2.5.1.4 "><p id="p106861129125213"><a name="p106861129125213"></a><a name="p106861129125213"></a>当选择包年包月时，该字段为必选，表示订购资源的周期类型。</p>
...
<tr id="row175146210419"><td class="cellrowborder" valign="top" width="18.87%" headers="mcps1.2.5.1.1 "><p id="p14771201151"><a name="p14771201151"></a><a name="p14771201151"></a>period_num</p>
</td>
<td class="cellrowborder" valign="top" width="13.170000000000002%" headers="mcps1.2.5.1.2 "><p id="p9771301656"><a name="p9771301656"></a><a name="p9771301656"></a>Integer</p>
</td>
<td class="cellrowborder" valign="top" width="7.8100000000000005%" headers="mcps1.2.5.1.3 "><p id="p877110458"><a name="p877110458"></a><a name="p877110458"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="60.150000000000006%" headers="mcps1.2.5.1.4 "><p id="p11771705518"><a name="p11771705518"></a><a name="p11771705518"></a>功能说明：订购周期数</p>
...
<tr id="row45794591236"><td class="cellrowborder" valign="top" width="18.87%" headers="mcps1.2.5.1.1 "><p id="p136634141157"><a name="p136634141157"></a><a name="p136634141157"></a>is_auto_renew</p>
</td>
<td class="cellrowborder" valign="top" width="13.170000000000002%" headers="mcps1.2.5.1.2 "><p id="p8663111412511"><a name="p8663111412511"></a><a name="p8663111412511"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="7.8100000000000005%" headers="mcps1.2.5.1.3 "><p id="p1766313141657"><a name="p1766313141657"></a><a name="p1766313141657"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="60.150000000000006%" headers="mcps1.2.5.1.4 "><p id="p136633141851"><a name="p136633141851"></a><a name="p136633141851"></a>功能说明：是否自动续订</p>
...
## **请求示例**<a name="section9574104313444"></a>
...
-   示例：
    ...
    **创建IMDG单机类型的缓存实例。**
    ...
    { 
        ...
        "security_group_id" : "1477393a-29c9-4de5-843f-18ef51257c8e", 
        "subnet_id" : "ec2f34b9-20eb-4872-85bd-bea9fc943129", 
        "available_zones" : ["1d7b939b382c4c3bb3481a8ca10da769"], 
        "product_id" : "XXXXXX", 
        "maintain_begin" : "22:00:00", 
        "maintain_end" : "02:00:00",
        "access_user": "XXXXXX", 
...
## 响应参数<a name="section93113588441"></a>

参数说明见[表6](#table079510368334)。 
...
<td class="cellrowborder" valign="top" width="56.57%" headers="mcps1.2.4.1.3 "><p id="p9471353151910"><a name="p9471353151910"></a><a name="p9471353151910"></a>缓存实例列表。具体参数，请参考<a href="#table128250386224">表7</a>。</p>
</td>
</tr>
</tbody>
</table>
...
## 响应示例<a name="section1811144124514"></a>
...
操作成功的状态码如[表8](#table217814394526)所示，其他响应见[表1](状态码.md#table5210141351517)。
