# 购买Memcached实例<a name="ZH-CN_TOPIC_0102039830"></a>
...
2.  在管理控制台左上角单击![](figures/zh-cn_image_0107538270.png)图标，选择区域和项目。

    >![](public_sys-resources/icon-note.gif) **说明：**   
    >此处请选择与租户的应用服务相同的区域。  

3.  单击页面上方的“服务列表”，选择“数据库 \> 分布式缓存服务”，进入分布式缓存服务信息页面。
4.  单击左侧菜单栏的“缓存管理”进入“缓存管理”页面。
5.  单击“购买缓存实例”，进入购买页面。
6.  选择“计费模式”，单击选择“包年/包月”或者“按需付费”。
7.  填写Memcached实例的参数。参数说明如[表1](#table5373863818728)所示。
    ...
    **表 1**  参数说明
    ...
    <tr id="row1546814278174"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.3.1.1 "><p id="p2398022111015"><a name="p2398022111015"></a><a name="p2398022111015"></a>备可区</p>
    </td>
    ...
    <tr id="row7228641453"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.3.1.1 "><p id="p92280414515"><a name="p92280414515"></a><a name="p92280414515"></a>购买量</p>
    </td>
    <td class="cellrowborder" valign="top" width="83%" headers="mcps1.2.3.1.2 "><a name="ul19691631111313"></a><a name="ul19691631111313"></a><ul id="ul19691631111313"><li>选择“包年/包月”付费模式时购买量包括使用时长和实例个数。</li><li>选择“按需付费”时购买量指购买缓存实例个数。</li></ul>
    </td>
    </tr>
    </tbody>
    </table>

8.  填写完上述信息后，单击“立即购买”，进入确认页面。
...
10. 缓存实例创建成功后，用户可以在“缓存管理”页面，查看并管理自己的缓存实例。
    1.  创建缓存实例大约需要5到15分钟。
