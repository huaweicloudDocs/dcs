...
4.  查询DCS缓存实例。
    -   支持通过筛选来查询对应的DCS缓存实例。
        ...
        当前支持的筛选条件为“项目”、“状态”、“名称”、“ID”、“IP地址”。缓存实例状态请参见[表1](#table5086721717534)。
        ...
        **表 1**  缓存实例状态说明
        ...
        <tbody><tr id="row16419272128"><td class="cellrowborder" valign="top" width="17.05%" headers="mcps1.2.3.1.1 "><p id="p1258272121"><a name="p1258272121"></a><a name="p1258272121"></a>变更规格中</p>
        </td>
        <td class="cellrowborder" valign="top" width="82.95%" headers="mcps1.2.3.1.2 "><p id="p2083415961512"><a name="p2083415961512"></a><a name="p2083415961512"></a>DCS缓存实例处于正在规格变更的状态。</p>
        </td>
        </tr>
        <tr id="row4409498617534"><td class="cellrowborder" valign="top" width="17.05%" headers="mcps1.2.3.1.1 "><p id="p5195001718130"><a name="p5195001718130"></a><a name="p5195001718130"></a>创建中</p>
        </td>
        ...
        <tr id="row196805519120"><td class="cellrowborder" valign="top" width="17.05%" headers="mcps1.2.3.1.1 "><p id="p1022935121239"><a name="p1022935121239"></a><a name="p1022935121239"></a>故障</p>
        </td>
        ...
        <tr id="row1228581120133"><td class="cellrowborder" valign="top" width="17.05%" headers="mcps1.2.3.1.1 "><p id="p549840112131"><a name="p549840112131"></a><a name="p549840112131"></a>启动中</p>
        </td>
        ...
        <tr id="row017313617130"><td class="cellrowborder" valign="top" width="17.05%" headers="mcps1.2.3.1.1 "><p id="p9173193601311"><a name="p9173193601311"></a><a name="p9173193601311"></a>清空中</p>
        </td>
        <td class="cellrowborder" valign="top" width="82.95%" headers="mcps1.2.3.1.2 "><p id="p1917353615132"><a name="p1917353615132"></a><a name="p1917353615132"></a>DCS缓存实例处于实例数据清空的状态。</p>
        </td>
        </tr>
        <tr id="row320195919134"><td class="cellrowborder" valign="top" width="17.05%" headers="mcps1.2.3.1.1 "><p id="p10731127154617"><a name="p10731127154617"></a><a name="p10731127154617"></a>升级中</p>
        </td>
        <td class="cellrowborder" valign="top" width="82.95%" headers="mcps1.2.3.1.2 "><p id="p17731277467"><a name="p17731277467"></a><a name="p17731277467"></a>DCS缓存实例正在升级的状态。</p>
        </td>
        </tr>
        <tr id="row1275881561414"><td class="cellrowborder" valign="top" width="17.05%" headers="mcps1.2.3.1.1 "><p id="p724310331011"><a name="p724310331011"></a><a name="p724310331011"></a>已冻结</p>
        </td>
        <td class="cellrowborder" valign="top" width="82.95%" headers="mcps1.2.3.1.2 "><p id="p122431831109"><a name="p122431831109"></a><a name="p122431831109"></a>DCS缓存实例处于已冻结状态，您可以在“我的订单”中续费开启冻结的DCS缓存实例。</p>
        </td>
        </tr>
        <tr id="row108671928171419"><td class="cellrowborder" valign="top" width="17.05%" headers="mcps1.2.3.1.1 "><p id="p2070814618130"><a name="p2070814618130"></a><a name="p2070814618130"></a>已关闭</p>
        </td>
        ...
        <tr id="row8089014121228"><td class="cellrowborder" valign="top" width="17.05%" headers="mcps1.2.3.1.1 "><p id="p3881314218130"><a name="p3881314218130"></a><a name="p3881314218130"></a>正在关闭</p>
        </td>
        ...
        <tr id="row23496423121248"><td class="cellrowborder" valign="top" width="17.05%" headers="mcps1.2.3.1.1 "><p id="p923161813135"><a name="p923161813135"></a><a name="p923161813135"></a>支付中</p>
        </td>
        <td class="cellrowborder" valign="top" width="82.95%" headers="mcps1.2.3.1.2 "><p id="p8230111813138"><a name="p8230111813138"></a><a name="p8230111813138"></a>DCS缓存实例处于支付中。</p>
        </td>
        </tr>
    ...
    -   支持通过缓存类型、版本号过滤DCS缓存实例。
        ...
        系统默认展示您所有的缓存实例。您可以单击“缓存类型”列的![](figures/icon-filter.png)，通过缓存类型（Redis、Memcached、IMDG）或者缓存版本（Redis 3.x、Redis 4.x、Redis 5.x）过滤实例。
...
5.  在需要查看的DCS缓存实例左侧，单击该实例的名称，进入实例的基本信息页面。参数说明如[表2](#table76493131315)所示。
    ...
    **表 2**  参数说明
    ...
    <tbody><tr id="row663413137116"><td class="cellrowborder" rowspan="16" valign="top" width="15.841584158415841%" headers="mcps1.2.4.1.1 "><p id="p16324131717"><a name="p16324131717"></a><a name="p16324131717"></a>基本信息</p>
    ...
    <td class="cellrowborder" valign="top" headers="mcps1.2.4.1.2 "><p id="p12342185502318"><a name="p12342185502318"></a><a name="p12342185502318"></a>DCS缓存实例的描述信息。单击“描述”后的<a name="image13421055132319"></a><a name="image13421055132319"></a><span><img id="image13421055132319" src="figures/icon-edit-2.png"></span>可以修改描述信息。</p>
    </td>
    </tr>
