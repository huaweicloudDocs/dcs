# 主备切换<a name="ChangeMasterStandby"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=DCS&api=ChangeMasterStandby)中调试该接口，并获取该接口关联的CLI示例：  [hcloud DCS ChangeMasterStandby](https://apiexplorer.developer.huaweicloud.com/apiexplorer/cli?product=DCS&api=ChangeMasterStandby)。

## URI

POST /v2/\{project\_id\}/instances/\{instance\_id\}/swap
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>主备切换成功。</p>
</td>
</tr>
