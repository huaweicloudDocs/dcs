# 删除大key分析记录<a name="DeleteBigkeyScanTask"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=DCS&api=DeleteBigkeyScanTask)中调试该接口，并获取该接口关联的CLI示例：  [hcloud DCS DeleteBigkeyScanTask](https://apiexplorer.developer.huaweicloud.com/apiexplorer/cli?product=DCS&api=DeleteBigkeyScanTask)。

## URI

DELETE /v2/\{project\_id\}/instances/\{instance\_id\}/bigkey-task/\{bigkey\_id\}
...
```
DELETE https://dcs.cn-south-1.myhuaweicloud.com/v2/a4d31cb6-3d72-4fdc-8ec9-6e3a41e47f71/instances/5560df16-cebf-4473-95c4-d1b573c16e79/bigkey-task/858ee14c-2271-4489-8b82-7bda7459ae3e
```
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>删除大key分析任务成功。</p>
</td>
</tr>
