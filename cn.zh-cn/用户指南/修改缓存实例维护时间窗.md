...
4.  单击左侧菜单栏的“缓存管理”。
5.  单击需要修改的DCS缓存实例名称。
6.  在打开的DCS缓存实例基本信息页面，单击“时间窗”后的![](figures/zh-cn_image_0088519226.jpg)。
7.  下拉选择新的维护时间窗。单击![](figures/zh-cn_image_0088519228.jpg)保存修改，单击![](figures/zh-cn_image_0088519230.jpg)取消修改。
