# 删除热key分析任务<a name="DeleteHotkeyScanTask"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=DCS&api=DeleteHotkeyScanTask)中调试该接口，并获取该接口关联的CLI示例：  [hcloud DCS DeleteHotkeyScanTask](https://apiexplorer.developer.huaweicloud.com/apiexplorer/cli?product=DCS&api=DeleteHotkeyScanTask)。

## URI

DELETE /v2/\{project\_id\}/instances/\{instance\_id\}/hotkey-task/\{hotkey\_id\}
...
```
DELETE https://dcs.cn-south-1.myhuaweicloud.com/v2/a4d31cb6-3d72-4fdc-8ec9-6e3a41e47f71/instances/5560df16-cebf-4473-95c4-d1b573c16e79/hotkey-task/0ccb25d5-27cf-4188-b5ea-987730a85371
```
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>删除热key分析记录成功。</p>
</td>
</tr>
