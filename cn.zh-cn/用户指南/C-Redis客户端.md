# C\# Redis客户端<a name="dcs-ug-0312013"></a>
...
6.  编写如下代码，并使用String的set和get测试连接。
    ...
    其中，_10.10.38.233:6379_分别为Redis实例的IP地址/域名以及端口。IP地址/域名和端口获取见[1](#li457118182512)，请按实际情况修改后执行。_\*\*\*\*\*\*\*\*_为创建Redis实例时自定义的密码，请按实际情况修改后执行。
