# 购买IMDG实例<a name="ZH-CN_TOPIC_0102039831"></a>
...
2.  在管理控制台左上角单击![](figures/zh-cn_image_0102039903.gif)图标，选择区域和项目。
...
5.  单击“购买缓存实例”，进入购买页面。
6.  选择“计费模式”，单击“按需付费”。
7.  填写IMDG实例的参数。参数说明如[表1](#table5373863818728)所示。
