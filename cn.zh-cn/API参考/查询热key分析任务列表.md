# 查询热key分析任务列表<a name="ListHotKeyScanTasks"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=DCS&api=ListHotKeyScanTasks)中调试该接口，并获取该接口关联的CLI示例：  [hcloud DCS ListHotKeyScanTasks](https://apiexplorer.developer.huaweicloud.com/apiexplorer/cli?product=DCS&api=ListHotKeyScanTasks)。

## URI

GET /v2/\{project\_id\}/instances/\{instance\_id\}/hotkey-tasks
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>分析任务状态</p>
<p>枚举值：</p>
...
<a name="response_HotkeyHistoriesResponse"></a>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>Array of <a href="#response_RecordsResponse">RecordsResponse</a> objects</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>热key分析记录列表</p>
</td>
</tr>
</tbody>
</table>
...
<a name="response_RecordsResponse"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.2"><p>参数类型</p>
</th>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>任务执行记录ID（此ID对应“查询大key/热key分析详情”参数中的任务ID）</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>分析任务开始时间,格式为："2020-06-15T02:21:18.669Z"</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>分析任务结束时间,格式为："2020-06-15T02:21:18.669Z"</p>
</td>
</tr>
</tbody>
</table>
...
```
GET https://dcs.cn-south-1.myhuaweicloud.com/v2/a4d31cb6-3d72-4fdc-8ec9-6e3a41e47f71/instances/5560df16-cebf-4473-95c4-d1b573c16e79/hotkey-tasks
```
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>查询热key分析任务列表。</p>
</td>
</tr>
