# 查询产品规格列表<a name="dcs-zh-api-180423048"></a>

## 功能描述<a name="section164151825713"></a>

在创建缓存实例时，需要配置订购的产品ID（即product\_id），可通过该接口查询产品规格。例如，要订购按需计费、实例类型为Redis3.x的主备实例，可从接口响应消息中，查找charging\_type字段为Hourly、spec\_code字段为dcs.master\_standby的记录对应的product\_id，该字段的值即是创建缓存实例时需要配置的产品ID。
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p1898112198347"><a name="p1898112198347"></a><a name="p1898112198347"></a>Redis缓存实例的产品类型。支持以下两种类型：</p>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p109817194340"><a name="p109817194340"></a><a name="p109817194340"></a>CPU架构类型。支持x86_64和aarch_64。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p1024735612348"><a name="p1024735612348"></a><a name="p1024735612348"></a>存储类型，支持DRAM和SCM。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p3247155613420"><a name="p3247155613420"></a><a name="p3247155613420"></a>支持的引擎版本号，以分号分割，如"3.0.7;4.0.11;5.0.11"。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="16.761676167616763%" headers="mcps1.2.4.1.2 "><p id="p1679753215316"><a name="p1679753215316"></a><a name="p1679753215316"></a>String</p>
</td>
