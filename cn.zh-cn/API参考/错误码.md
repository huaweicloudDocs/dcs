...
<td class="cellrowborder" valign="top" width="69.69696969696969%" headers="mcps1.2.4.1.3 "><p id="p356916197274"><a name="p356916197274"></a><a name="p356916197274"></a>实例状态为创建中、重启中、删除中时不允许执行删除操作。</p>
</td>
</tr>
