# 创建大key分析任务<a name="CreateBigkeyScanTask"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=DCS&api=CreateBigkeyScanTask)中调试该接口，并获取该接口关联的CLI示例：  [hcloud DCS CreateBigkeyScanTask](https://apiexplorer.developer.huaweicloud.com/apiexplorer/cli?product=DCS&api=CreateBigkeyScanTask)。

## URI

POST /v2/\{project\_id\}/instances/\{instance\_id\}/bigkey-task
...
```
POST https://dcs.cn-south-1.myhuaweicloud.com/v2/a4d31cb6-3d72-4fdc-8ec9-6e3a41e47f71/instances/5560df16-cebf-4473-95c4-d1b573c16e79/bigkey-task
```
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>创建大key分析任务成功。</p>
</td>
</tr>
