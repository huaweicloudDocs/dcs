# 关闭缓存实例<a name="zh-cn_topic_0033568421"></a>

DCS管理控制台支持关闭已购买的DCS缓存实例，且可批量关闭DCS缓存实例。

>![](public_sys-resources/icon-warning.gif) **警告：**   
>-   DCS缓存实例关闭后，您无法再对实例进行读写操作，其中单机实例中的数据将被删除。  
...
6.  单击“是”，完成关闭DCS实例。
    ...
    **图 1**  关闭缓存实例<a name="fig1677418171217"></a>  
    ![](figures/关闭缓存实例.png "关闭缓存实例")


## 使用API方式关闭缓存实例<a name="section1983962016368"></a>

您还可以使用API的方式关闭实例，具体操作请查看以下链接。
