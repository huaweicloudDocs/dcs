# 开启Redis实例的免密访问<a name="ZH-CN_TOPIC_0100102141"></a>
...
2.  在管理控制台左上角单击![](figures/zh-cn_image_0100102146.gif)图标，选择区域和项目。
...
4.  单击左侧菜单栏的“缓存管理”。
5.  在需要开启免密访问的Redis实例右侧，单击“操作”栏下的“更多 \> 重置密码”。
6.  系统弹出“重置密码”对话框，打开“免密访问”开关。
7.  单击“点击获取验证码”，输入验证码。单击“确定”完成免密访问设置。
